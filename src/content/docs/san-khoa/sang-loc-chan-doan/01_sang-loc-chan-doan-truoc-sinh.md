...
- Test sàng lọc không phải là chẩn đoán: Khi test nguy cơ cao không có nghĩa là thai bị bệnh. Cần phải thực hiện chẩn đoán trước sinh.
- Chọc ối và các test sàng lọc không bắt buộc, do đó bệnh nhân phải ký xác nhận và ghi rõ là đã hiểu hết hạn chế và lợi ích của các test sàng lọc.

...
### Quy tắc viết chữ số và chữ (Number Writing Rules)

Kiểm tra văn bản và chỉ chuyển đổi các chữ số (0-9 hoặc các số khác) thành chữ khi văn phong và ngữ pháp bắt buộc hoặc khuyên dùng.

1. **Các trường hợp bắt buộc/khuyên dùng chuyển số thành chữ:**
...
2. **Các trường hợp tuyệt đối giữ nguyên dạng chữ số (không chuyển đổi):**
